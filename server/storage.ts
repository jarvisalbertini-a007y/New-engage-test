...
export class MemStorage implements IStorage {
  ...
  async createSequence(insertSequence: InsertSequence): Promise<Sequence> {
    const id = randomUUID();
    const sequence: Sequence = { ...insertSequence, id, createdAt: new Date() };
  ...
  async createEmail(insertEmail: InsertEmail): Promise<Email> {
    const id = randomUUID();
    const email: Email = { ...insertEmail, id, createdAt: new Date() };
  ...
  async createPersona(insertPersona: InsertPersona): Promise<Persona> {
    const id = randomUUID();
    const persona: Persona = { ...insertPersona, id, createdAt: new Date() };
