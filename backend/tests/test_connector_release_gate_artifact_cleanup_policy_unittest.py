...
def _load_script_module():
    spec = importlib.util.spec_from_file_location(
        "evaluate_connector_release_gate_artifact_cleanup_policy",
        SCRIPT_PATH,
    )
...
def test_connector_release_gate_policy_skips_when_no_candidates():
...
def test_connector_release_gate_policy_requires_manual_action_when_over_threshold():
    module = _load_script_module()
    result = module.evaluate_policy_from_summary(
...
def test_connector_release_gate_policy_requires_env_gate_when_flag_missing():
    module = _load_script_module()
    result = module.evaluate_policy_from_summary(
...
def test_connector_release_gate_policy_allows_apply_when_within_threshold_and_flag_set():
    module = _load_script_module()
    result = module.evaluate_policy_from_summary(
