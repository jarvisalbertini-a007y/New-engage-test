#!/usr/bin/env python3
"""Cleanup stale connector release-gate artifacts with dry-run safety."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Cleanup stale connector release-gate artifacts."
    )
    parser.add_argument(
        "--artifact-dir",
        default="backend/test_reports",
        help="Directory containing connector release-gate artifacts.",
    )
    parser.add_argument(
        "--prefix",
        default="connector_release_gate_result",
        help="Connector release-gate artifact filename prefix.",
    )
    parser.add_argument(
        "--keep-days",
        type=int,
...
def main() -> int:
    ...
    print(
        f"Connector release-gate artifact cleanup {summary['mode']} completed: "
