#!/usr/bin/env python3
"""Cleanup stale event-root backfill fixture artifacts with dry-run safety."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Cleanup stale event-root backfill fixture artifacts."
    )
    parser.add_argument(
        "--artifact-dir",
...
def main() -> int:
    ...
    print(
        f"Event-root backfill artifact cleanup {summary['mode']} completed: "
