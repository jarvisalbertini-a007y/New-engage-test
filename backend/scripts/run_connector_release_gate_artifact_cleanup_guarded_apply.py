#!/usr/bin/env python3
"""Apply release-gate artifact cleanup only when policy gate allows."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Apply connector release-gate artifact cleanup only when policy allows."
    )
    parser.add_argument(
        "--artifact-dir",
...
def main() -> int:
    ...
    cleanup_module = _load_module("cleanup_connector_release_gate_artifacts.py")
