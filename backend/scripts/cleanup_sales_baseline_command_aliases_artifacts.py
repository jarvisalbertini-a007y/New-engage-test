#!/usr/bin/env python3
"""Cleanup stale baseline command-alias artifacts with dry-run safety."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Cleanup stale baseline command-alias artifacts."
    )
    parser.add_argument(
        "--artifact-dir",
...
def main() -> int:
    ...
    print(
        f"Baseline command-alias artifact cleanup {summary['mode']} completed: "
